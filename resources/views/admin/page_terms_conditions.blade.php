                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="terms_content" id="" class="form-control snote" cols="30" rows="10">
                                        {{ $page_data->terms_content }}
                                    </textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Status *</label>
                                    <select name="terms_status" id="" class="form-control">
                                        <option value="1" @if($page_data->terms_status == 1) selected @endif > 
                                        Show </option>
