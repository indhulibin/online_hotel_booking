...
class AdminTestimonialController extends Controller
{
    public function index()
    {
        ...
        return view('admin.testimonial_view',compact('testmonial'));
    }

    public function add()
    {
        return view('admin.testmonial_add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $obj->save();
        return redirect()->back()->with('success','Testmonial is added successfully');
    }

    public function edit($id)
    {
        $testimonial_data = Testimonial::where('id',$id)->first();
        return view('admin.testmonial_edit',compact('testimonial_data'));
    }
