...
class AdminPageController extends Controller
{
    ...
    public function cart_update(Request $request)
    {
        ...
        $obj->update();
       return redirect()->back()->with('success','Cart data is updated successfully');
    }
    ...
    public function checkout_update(Request $request)
    {
        ...
        $obj->update();
       return redirect()->back()->with('success','Checkout data is updated successfully');
    }
    ...
    public function payment_update(Request $request)
    {
        ...
        $obj->update();
       return redirect()->back()->with('success','Payment data is updated successfully');
    }
    ...
    public function signup_update(Request $request)
    {
        ...
        $obj->update();
       return redirect()->back()->with('success','SignUp data is updated successfully');
    }
